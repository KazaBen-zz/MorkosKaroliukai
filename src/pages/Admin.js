...
import { createApyranke } from '../api/mutations'
...
const Admin = () => {
    ...
    const [bookDetails, setBookDetails] = useState({ title: "", description: "", image: "", price: "" });
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            await API.graphql(graphqlOperation(createApyranke, { input: bookDetails }))
            setBookDetails({ title: "", description: "", image: "", price: "" })
        } catch (err) {
